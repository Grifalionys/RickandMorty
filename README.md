...
В пункте 5 мы видим список персонажей, которые присутствует в данном эпизоде. При выборе персонажа мы перейдем на детальный экран конкретного персоанажа.
